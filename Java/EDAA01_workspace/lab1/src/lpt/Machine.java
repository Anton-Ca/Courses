...
public class Machine {
	private int nbr; // private -> public
	private ArrayList<Job> jobs; // private -> public
	...
	public void assignJob(Job j) {
		jobs.add(j);
		scheduledTime += j.getTime(); // += fixar felet
	}
	...
	/**
	 * Tar reda på den totala schemalagda tiden för maskinens jobb.
	 */
	...
	/**
	 * Returnerar en sträng som innehåller maskinens nr, total schemalagd tid samt
	 * maskinens schemalagda jobb inom [] med kommatecken mellan. Exempel: 2 17 [j2
	 * (14), j7 (3)]
	 */
